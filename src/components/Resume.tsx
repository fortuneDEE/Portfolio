...
const Resume = () => {
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center md:flex-row gap-6 sm:px-16 md:px-0 mx-auto">
        {/* Experience Section */}
        <div className="w-full">
          ...
          <div className="cursor-pointer">
            ...
            <div className="flex p-5 flex-col bg-white rounded-3xl hover:bg-blue-800 hover:text-white mb-5 shadow-lg transition duration-300">
              ...
              <h2 className="uppercase font-bold">Client Services Officer</h2>
              <p className="text-sm">Axiom Parasol Global Limited</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          <h1 className="text-3xl lg:text-4xl font-bold flex items-center leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-gray-900 my-12 sm:mt-0 lg:mb-8">
            <IoIosSchool size={35} className="mr-3 from-blue-500 to-gray-900" />
            My Education
          </h1>
          <div className="cursor-pointer">
            <div className="flex p-5 flex-col bg-white rounded-3xl hover:bg-blue-800 hover:text-white mb-5 shadow-lg transition duration-300">
              ...
              <h2 className="uppercase font-bold">React Learning Program</h2>
