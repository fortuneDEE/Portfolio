      ...
      <div className="flex flex-col md:flex-row-reverse items-center">
        <div className="flex flex-col w-full space-y-8 md:ml-16 lg:w-1/2 mb-12">
          <div className="flex items-center space-x-4">
            <div className="border-2 rounded-full bg-blue-500 text-white p-4">
        ...
        <div className="w-full lg:w-1/2">
          <form className="rounded-xl bg-white shadow-lg p-8">
            ...
            <div className="flex flex-col md:flex-row md:space-x-2 mb-4">
              <input
                ...
                className="w-full border-2 bg-blue-50 rounded-md p-2 mb-4 md:mb-0"
              />
              <input
                type="text"
                placeholder="Last Name"
                className="w-full border-2 bg-blue-50 rounded-md p-2"
              />
            </div>
            <div className="flex flex-col md:flex-row md:space-x-2 mb-4">
              <input
